...
export class Rfq {
  ...
  loadWorkitems() {
    this.rfq = [
      {
        id: 'Pp101014',
        name: 'Meijs Schilderwerken	',
        customer: 'William Joseph	',
        rfqSentDate: '23-07-2025',
        dueDate: '23-08-2025',
        rfqSent: '12',
        quoteRecieved: '5',
      },
      {
        id: 'Pp101013',
        name: '	Citydocks Amsterdam		',
        customer: 'Eva Pertersen	',
        rfqSentDate: '23-01-2024',
        dueDate: '01-02-2024',
        rfqSent: '23',
        quoteRecieved: '15',
      },
      {
        id: 'Pp101012',
        name: 'Alblas Houthandel	',
        customer: 'Matthew Mark	',
        rfqSentDate: '16-09-2024',
        dueDate: '15-10-2024 ',
        rfqSent: '20',
        quoteRecieved: '14',
      },
      {
        id: 'Pp101011',
        name: 'VDG Real Estate Venlo	',
        customer: 'Timothy Ronald',
        rfqSentDate: '23-07-2025',
        dueDate: '23-08-2025',
        rfqSent: '12',
        quoteRecieved: '5',
  ...
  applyFilter() {
    ...
    this.filteredItems = this.rfq.filter(
      (item) =>
